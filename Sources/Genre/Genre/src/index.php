				...
				<div class="col-md-12">
					...
					<div class="row">
						...
						<span class="col-md-8 navnav">
							...
							<a class="Menu" style="text-decoration: none" href="index.html">GENRE</a>
							<!-- <div class="dropdown">
			...
			<div class="genre row">
				<div class="sidegenre col-md-2">
					<ul>
						...
						$result = mysqli_query($conn,"SELECT Genre,ID_G from genre ORDER BY ID_G DESC LIMIT 6");
						while($data=mysqli_fetch_assoc($result)) {
							echo"<li style='margin-top: 10%;color:white'><a class='sideMenu' href='list_review.php?id=$data[ID_G]' style='text-decoration: none'>$data[Genre]</a></li>";
				...
				<?php
                                    ...
                                    $result = mysqli_query($conn,"SELECT Film,pre_image,Genre,film.ID_F FROM film,genre,child WHERE film.ID_F=child.ID_F AND genre.ID_G=child.ID_G GROUP BY genre.Genre,film.ID_F ORDER BY film.ID_F DESC");
                                            while($data = mysqli_fetch_assoc($result)) {
